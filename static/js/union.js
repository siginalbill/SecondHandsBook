        ...
        $.getJSON('/book/account_bookbuy/', function (ret) {
            ...
            $.each(ret, function (i, item) {
                ...
                if (item["status"] == 1) {
                    ...
                    operations = '<td class="op"><a class="a_show" href="#" bookid = "' + bookid + '">查看</a>' + ' <a class="a2_show" href="/chat/chat/?recver_name=' + item["sellername"] + '">联系卖家</a>' + ' <a id="buy_cancel" bookid="' + bookid + '" href="#">取消订单</a></td>';
                }
                if (item["status"] == 2) {
                    ...
                    tradebrief = '<td>' + item["tradebrief"] + '</td>';
                    trdadetime = '<td>' + item["tradetime"] + '</td>';
                    operations = '<td class="op"><a class="a_show" href="#" bookid = "' + bookid + '">查看</a>' + ' <a class="a2_show" href="/chat/chat/?recver_name=' + item["sellername"] + '">联系卖家</a>' + ' <a id="sell_already" bookid="' + bookid + '" href="#">已结束</a></td>';
                }
            ...
            $.getJSON('/book/account_booksell/', function (ret) {
                ...
                $.each(ret, function (i, item) {
                    ...
                    if (item["status"] == 1) {
                        ...
                        tradebrief = '<td>' + item["tradebrief"] + '</td>';
                        trdadetime = '<td>' + item["tradetime"] + '</td>';
                        operations = '<td class="op"><a class="a_show" href="#" bookid = "' + bookid + '">查看</a>' + ' <a class="a2_show" href="/chat/chat/?recver_name=' + item["buyername"] + '">联系买家</a>' + ' <a id="sell_makesure" bookid="' + bookid + '" href="#">确认完成交易</a> <a id="sell_refuse" bookid="' + bookid + '" href="#">拒绝交易</a></td>';
                    }
                    if (item["status"] == 2) {
                        ...
                        tradebrief = '<td>' + item["tradebrief"] + '</td>';
                        trdadetime = '<td>' + item["tradetime"] + '</td>';
                        operations = '<td class="op"><a class="a_show" href="#" bookid = "' + bookid + '">查看</a>' + ' <a class="a2_show" href="/chat/chat/?recver_name=' + item["buyername"] + '">联系买家</a>' + ' <a id="sell_already" bookid="' + bookid + '" href="#">已结束</a></td>';
                    }
